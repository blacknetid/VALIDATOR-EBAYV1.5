...
<h1 align="center">
  <br>
  <a href="http://www.darkxcode.site"><img src="https://raw.githubusercontent.com/blacknetid/VALIDATOR-EBAYV1.5/master/img/ebay.png" alt="ebay" width="200"></a>
  <br>
  EBAY VALIDATOR EMAIL CLI VERSION
  <br>
</h1>

<h4 align="center">This tool can ebay validator email new version</h4>
...
```bash
- Install Python 3++
- git clone https://github.com/blacknetid/VALIDATOR-EBAYV1.5.git
- set up the Python environment variable
- Goto folder VALIDATOR-EBAYV1.5
- open cmd and type python ebay.py
- enjoy
``` 
